    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <input type="hidden" id="package" name="package_name" value="Instagram - 1000 Likes">
                ...
                <h2 style="font-weight: bold;" class="form_title">₱349</h2>
                <h3 class="form_title">1,000 Instagram Likes</h3>
