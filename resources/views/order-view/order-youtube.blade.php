    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <h3 class="form_title">Youtube</h3>
                <div class="form_message form_message--error"></div>
                <div class="form_input-group">
                    <select class="form_input" name="service_name" autofocus placeholder="Services">
                        <option id="offer-youtube" name="service_name" value="youtube_views">Views</option>
                        <option id="offer-youtube" name="service_name" value="youtube_likes">Likes</option>
                        <option id="offer-youtube" name="service_name" value="youtube_subs">Subscribers</option>
                        </option>
                    </select>
                </div>
                <div class="form_input-group">
