    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <input type="hidden" id="service" name="service" value="1680">
                <input type="hidden" id="package" name="package_name" value="Facebook Page - 10,000 Likes & Followers">
                ...
                <h2 style="font-weight: bold;" class="form_title">₱8,000</h2>
                <h3 class="form_title">10,000 Facebook Page Likes & Followers</h3>
                <div class="form_message form_message--error"></div>
                <div class="form_input-group">
                    <input type="text" name="link" class="form_input" autofocus placeholder="Facebook Page URL" >
                </div>
