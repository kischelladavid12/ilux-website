            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <div class="form_input-group">
                    <select class="form_input" name="service_name" autofocus placeholder="Services">
                        <option id="offer-facebook" name="service_name" value="facebook_page-likes-and-followers">
                            Page Likes and Followers</option>
                        <option id="offer-facebook" name="service_name" value="facebook_reacts">Reacts</option>
                        <option id="offer-facebook" name="service_name" value="facebook_views">Views</option>
                        <option id="offer-facebook" name="service_name" value="facebook_group">Group Member/Events
                        </option>
                        <option id="offer-facebook" name="service_name" value="facebook_events">Event Join
                        </option>
                        <option id="offer-facebook" name="service_name" value="facebook_live-react">Livestream Reacts
                        </option>
                    </select>
                </div>
                <div class="form_input-group">
                ...
                <div class="form_input-group">
                    <input type="number" name="quantity" class="form_input" min="100" max="100000"
