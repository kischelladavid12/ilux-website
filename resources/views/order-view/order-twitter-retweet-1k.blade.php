    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <input type="hidden" id="service" name="service" value="2263">
                <input type="hidden" id="package" name="package_name" value="Twitter - 1,000 Retweet">
                <input type="hidden" id="price" name="price" value="1,199">
                <input type="hidden" id="quantity" name="quantity" value="1000">
        
                <h5 class="form_title">Order Process Form</h5>
                <h2 style="font-weight: bold;" class="form_title">₱1,199</h2>
                <h3 class="form_title">1,000 Twitter Retweet</h3>
                <div class="form_message form_message--error"></div>
                <div class="form_input-group">
                    <input type="text" name="link" class="form_input" autofocus placeholder="URL Twitter Account" >
                </div>
