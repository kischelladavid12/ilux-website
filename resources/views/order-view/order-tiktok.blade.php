            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <div class="form_input-group">
                    <select class="form_input" name="service_name" autofocus placeholder="Services">
                        <option id="offer-tiktok" name="service_name" value="tiktok_followers">Followers</option>
                        <option id="offer-tiktok" name="service_name" value="tiktok_likes">Likes</option>
                        <option id="offer-tiktok" name="service_name" value="tiktok_views">Views</option>
                        <option id="offer-tiktok" name="service_name" value="tiktok_phviews">Philippines Views
                        </option>
                        <option id="offer-tiktok" name="service_name" value="tiktok_phtarget">Philippines Target Ads
                        </option>
                    </select>
                </div>
                <div class="form_input-group">
