    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <input type="hidden" id="package" name="package_name" value="Tiktok - 100,000 Followers">
                <input type="hidden" id="price" name="price" value="49,999">
                <input type="hidden" id="quantity" name="quantity" value="100000">
        
                <h5 class="form_title">Order Process Form</h5>
                <h2 style="font-weight: bold;" class="form_title">₱49,999</h2>
                <h3 class="form_title">100,000 Tiktok Followers</h3>
