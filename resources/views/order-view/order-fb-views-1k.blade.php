    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <input type="hidden" id="service" name="service" value="1982">
                <input type="hidden" id="package" name="package_name" value="Facebook Profile - 1,000 Views">
                ...
                <h2 style="font-weight: bold;" class="form_title">₱299</h2>
                <h3 class="form_title">1,000 Facebook Video/Story Views </h3>
