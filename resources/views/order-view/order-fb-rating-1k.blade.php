    ...
    <div id="form">
        <div class="container-login ">
            ...
            <form action="{{ url('/order/form-submit') }}" method="POST" class="form" id="order">
                ...
                <input type="hidden" id="package" name="package_name" value="Facebook Page - 1,000 ratings and comments">
                <input type="hidden" id="price" name="price" value="2,999">
        
                <h5 class="form_title">Order Process Form</h5>
                <h2 style="font-weight: bold;" class="form_title">₱2,999</h2>
                <h3 class="form_title">1,000 Facebook Page Ratings with Random Comments</h3>
                <div class="form_message form_message--error"></div>
                <div class="form_input-group">
                    <input type="text" name="link" class="form_input" autofocus placeholder="Facebook Page URL" >
                </div>
                <button class="form_button mb-3" type="submit" href="/">Order Now</button>
                <p class="form_text">
