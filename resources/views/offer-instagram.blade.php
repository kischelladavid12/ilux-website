                ...
                <div class="card-deck">
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="/order-ig-follow-1k">Boost Now!</a>
                        </div>
                    </div>
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="/order-ig-follow-10k">Boost Now!</a>
                        </div>
                    </div>
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="/order-ig-follow-100k">Boost Now!</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-deck">
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ Refill in 24 hours if drops occured</p>
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="/order-ig-likes-1k">Boost Now!</a>
                        </div>
                    </div>
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ Location & Gender based targeting</p>
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="/order-ig-likes-10k">Boost Now!</a>
                        </div>
                    </div>
                </div>
            </div>
