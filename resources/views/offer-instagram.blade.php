                            ...
                            <div class="d-flex h-100">
                                <div class="project-text w-100 my-auto text-center text-lg-left">
                                    <div class="text">
                                        ...
                                        <a class="btn btn-primary" href="offer-instagram.html#ig-follow">Instagram
                                            Followers</a><br><br>
                                        <a class="btn btn-primary" href="offer-instagram.html#ig-likes">Instagram
                                            Likes</a>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="container px-4 px-lg-5">
                    ...
                    <div class="container tm-container-gallery">
                        <div class="row row-offer">
                            <div class="text-center col-12">
                                <img id="ig" src="img/insta-logo.png" alt="instagram-logo">
                                <h2 class="tm-text-primary tm-section-title mb-4">Instagram Followers Growth Plans</h2>
                                <p class="mx-auto tm-section-desc">
                                    Get Started Today, with your very own Instagram Marketer. Setup your campaign,
                                    you'll be
                                    receiving your first followers within hours!
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-deck">
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <a class="btn btn-primary" href="order-ig-follow-1k.html">Boost Now!</a>
                        </div>
                    </div>
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="order-ig-follow-10k.html">Boost Now!</a>
                        </div>
                    </div>
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="order-ig-follow-100k.html">Boost Now!</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="container px-4 px-lg-5">
                    ...
                    <div class="container tm-container-gallery">
                        <div class="row row-offer">
                            <div class="text-center col-12">
                                <img id="ig" src="img/insta-logo.png" alt="instagram-logo">
                                <h2 class="tm-text-primary tm-section-title mb-4">Instagram Likes Growth Plans</h2>
                                <p class="mx-auto tm-section-desc">
                                    Get Started Today, with your very own Instagram Marketer. Setup your campaign,
                                    you'll be
                                    receiving your likes within hours!
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-deck">
                    <div class="card-plan">
                        <div class="card-body">
                            ...
                            <p> ✓ Refill in 24 hours if drops occured</p>
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="order-ig-likes-1k.html">Boost Now!</a>
                        </div>
                    </div>
                    <div class="card-plan">
                        <div class="card-body">
                            <h5>STANDARD</h5>
                            <h1>₱3490</h1>
                            <h5 style="font-weight: bold;">10000 Likes</h5>
                            <hr>
                            <p> ✓ Faster likes growth</p>
                            <p> ✓ Weekly optimization reviews</p>
                            <p> ✓ Location & Gender based targeting</p>
                            <p> ✓ 100% Money Back Guarantee</p>
                            <a class="btn btn-primary" href="order-ig-likes-10k.html">Boost Now!</a>
                        </div>
                    </div>
                </div>
            </div>
